...
var _modelJs = require("./model.js"); // Importing the model
...
const controlAddRecipe = async function(newRecipe) {
    try {
        ...
        // Render recipe
        console.log((0, _recipeViewJsDefault.default).render());
        (0, _recipeViewJsDefault.default).render(_modelJs.state.recipe);
        // Success message
...
const init = function() {
    ...
    (0, _addRecipeViewJsDefault.default).addHandlerUploadeWindow(controlAddRecipe);
};
init();

},{"core-js/modules/web.immediate.js":"bzsBv","./model.js":"3QBkH","regenerator-runtime/runtime":"f6ot0","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./views/recipeView.js":"3wx5k","./views/resultView.js":"2iOri","./views/searchView.js":"kbE4Z","regenerator-runtime":"f6ot0","./views/paginationView.js":"7NIiB","./views/bookmarkView.js":"jPLC7","./views/addRecipeView.js":"8AWnP","./config.js":"2hPh4"}],"bzsBv":[function(require,module,exports,__globalThis) {
'use strict';
...
const uploadRecipe = async function(newRecipe) {
    try {
        const ingredients = Object.entries(newRecipe).filter((entry)=>entry[0].startsWith('ingredient') && entry[1] !== '').map((ing)=>{
            ...
            if (ingArr.length !== 3) throw new Error('Wrong ingredient format! Please use correct ingredient format :)');
...
const KEY = 'feabe219-536e-4975-ae85-28bc8d474334';
...
},{"regenerator-runtime/runtime":"f6ot0","./config.js":"2hPh4","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"3wx5k":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class addRecipeView extends (0, _viewJsDefault.default) {
    ...
    _Message = 'Recipe are successfuly uploaded :)';
    ...
    addHandlerUploadeWindow(handler) {
